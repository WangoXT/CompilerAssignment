...
/* External objects */
extern bab_intg line; /* Source code line numbers - defined in scanner.c */
 ...
 * -------------------------------------------------------------
 */
bab_void printScannerError(bab_char* fmt, ...);
bab_void displayScanner(BufferReader* ptrBuffer);
bab_long getScannerFilesize(bab_char* fname);
